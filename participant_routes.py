...
def participant_moments():
    ...
    return render_template('participant/moments.html', researcher_details={'name':project.consultants[0].display_name, 'email':project.consultants[0].email}, support_details={'contact_email':app.config['SUPPORT_DETAILS']['contact_email'], 'contact_name':app.config['SUPPORT_DETAILS']['contact_email']})
